...
def seed():
    ...
    users = [
        ...
        ("u8", "Sarah Miller", "050-8888888", "en", "pharmacist"),
        ("u9", "אבי רון", "050-9999999", "he", "customer"),
        ("u10", "Liam Stone", "050-1010101", "en", "customer"),
        ("u11", "Omer Johnson", "050-1111112", "en", "pharmacist"),
        ("u12", "Rachel Moore", "050-1212121", "en", "pharmacist"),
        ("u13", "Michael Cohen", "050-1313131", "en", "pharmacist"),
    ]
    ...
    medications_sold = [
        ...
        # M3 sales - 2023
        ("ms11", "m3", "u3", "p5", 20, 0.85, 17.0, "2023-03-08 13:15:00", 2023, 3, 8),
        ("ms12", "m3", "u5", None, 45, 0.80, 36.0, "2023-06-20 10:45:00", 2023, 6, 20),
        ("ms13", "m3", "u1", "p6", 25, 0.85, 21.25, "2023-10-14 14:30:00", 2023, 10, 14),

        # M4 sales - 2023
        ("ms14", "m4", "u2", "p7", 15, 2.50, 37.5, "2023-01-22 09:20:00", 2023, 1, 22),
        ("ms15", "m4", "u4", None, 10, 2.45, 24.5, "2023-07-11 16:10:00", 2023, 7, 11),
        ("ms16", "m4", "u10", "p8", 20, 2.50, 50.0, "2023-11-05 11:50:00", 2023, 11, 5),
        ...
        # M3 sales - 2024
        ("ms17", "m3", "u3", "p5", 35, 0.90, 31.5, "2024-02-14 12:25:00", 2024, 2, 14),
        ("ms18", "m3", "u1", None, 50, 0.85, 42.5, "2024-05-30 15:45:00", 2024, 5, 30),
        ("ms19", "m3", "u5", "p6", 30, 0.90, 27.0, "2024-08-19 10:00:00", 2024, 8, 19),
        ("ms20", "m3", "u4", "p5", 40, 0.88, 35.2, "2024-12-03 14:35:00", 2024, 12, 3),

        # M4 sales - 2024
        ("ms21", "m4", "u2", "p7", 12, 2.60, 31.2, "2024-02-28 13:40:00", 2024, 2, 28),
        ("ms22", "m4", "u10", None, 18, 2.55, 45.9, "2024-04-16 09:50:00", 2024, 4, 16),
        ("ms23", "m4", "u3", "p8", 25, 2.60, 65.0, "2024-09-10 11:15:00", 2024, 9, 10),
        ("ms24", "m4", "u1", "p7", 14, 2.65, 37.1, "2024-10-22 15:20:00", 2024, 10, 22),
        ...
        # M3 sales - 2025
        ("ms25", "m3", "u5", "p5", 45, 0.95, 42.75, "2025-01-28 10:30:00", 2025, 1, 28),
        ("ms26", "m3", "u2", None, 55, 0.92, 50.6, "2025-03-15 14:10:00", 2025, 3, 15),
        ("ms27", "m3", "u3", "p6", 35, 0.95, 33.25, "2025-06-22 12:50:00", 2025, 6, 22),
        ("ms28", "m3", "u4", "p5", 40, 0.93, 37.2, "2025-08-30 16:00:00", 2025, 8, 30),

        # M4 sales - 2025
        ("ms29", "m4", "u1", "p7", 16, 2.75, 44.0, "2025-02-11 11:25:00", 2025, 2, 11),
        ("ms30", "m4", "u10", "p8", 22, 2.70, 59.4, "2025-05-20 09:45:00", 2025, 5, 20),
        ("ms31", "m4", "u5", None, 20, 2.72, 54.4, "2025-07-09 13:55:00", 2025, 7, 9),
    ]
